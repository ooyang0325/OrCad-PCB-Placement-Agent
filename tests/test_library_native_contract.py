...
class LibraryNativeContractTests(unittest.TestCase):
    ...
    def test_library_attached_text_is_owned_bounded_complete_and_not_a_placement_guard_change(self):
        ...
        self.assertIn("opaLibraryObject(text object ancestors depth + 1 budget placementDefinition)", method)
        self.assertIn("key == 'instances && placementDefinition", method)
        self.assertIn("instance->component->symbol == instance", method)
